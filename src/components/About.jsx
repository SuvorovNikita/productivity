    ...
    return (
        <>
            <section className="c-section c-section--base">
                <div className="c-section__images"></div>
                        ...
                        <div className="c-card c-card--base">
                            <div className="c-card__body">
                                ...
                                <div className="c-card__inner">
                                    ...
                                    <p className="c-card__text">No vim nulla vitae intellegat. Ei enim error ius, solet
                                ...
                                <div className="c-card__inner">
                                    ...
                                    <p className="c-card__text">Vim ne tacimates neglegentur. Erat diceret omittam at
                                        est.</p>
                                </div>
                                <div className="c-section__line"></div>
                                <div className="c-card__inner">
                            ...
                            <div className="c-section__actions-3">
                              <div className="c-button c-button--base c-button--base-red c-button--base-small">Read more</div>
                                <div className="c-section__line-small"></div>
                                <div className="c-section__text-4">or</div>
                                <div className="c-section__line-small"></div>
                              <div className="c-button c-button--base c-button--base-blue c-button--base-small">Get started</div>
                            </div>
                        </div>
                    </div>
                </div>
